...
def contact():
    mess._show(title='Contact us', message="Please contact us on : '542001basudevgorai@gmail.com' ")
...
def send_email():
    ...
    from_email = "542001rajagorai@gmail.com"  # my mail
    password = "rkly orbg ofun irkl"  # my email password
